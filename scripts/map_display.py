...
def start():
    ...
    angle_mean = np.ones((1,9))
    distance_mean = np.ones((1,9))

    r = rospy.Rate(10)
    index_runs = 0
    while not rospy.is_shutdown():
         # loading the frame
        frame = cv2.cvtColor(cv2.imread('/home/zack/v1_robotws/src/trying_again/map_11.jpg'),cv2.COLOR_BGR2GRAY)
        ...
        #Save image
        cv2.imwrite('/home/zack/v1_robotws/src/trying_again/map_11.jpg', frame)
